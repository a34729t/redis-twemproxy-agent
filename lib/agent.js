...
Agent.prototype.force_master_update = function() {
  var self = this;
  var client2 = randSentinel(self.redis_sentinel_ips, self.redis_sentinel_port);
...
Agent.prototype.start_sentinel = function(){
  ...
  this.client = randSentinel(self.redis_sentinel_ips, self.redis_sentinel_port);
...
function randSentinel(redis_sentinel_ips, redis_sentinel_port){
  var randomSentinelIP = rand(redis_sentinel_ips);
